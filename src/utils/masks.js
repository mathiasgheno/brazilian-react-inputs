...
export function numberMask (value) {
  ...
  if(value.length >= 31) {
  //  100.000.000.000.000.000.000,000 -> 1.000.000.000.000.000.000.000,00
  return value
    .replace(/\D/g, '')
    .replace(/(\d{1})(\d{3})(\d{3})(\d{3})(\d{3})(\d{3})(\d{3})(\d{3})(\d{1,2})/, '$1.$2.$3.$4.$5.$6.$7.$8,$9');
}

  if(value.length >= 30) {
    //10.000.000.000.000.000.000,000 -> 100.000.000.000.000.000.000,00
    return value
      .replace(/\D/g, '')
      .replace(/(\d{3})(\d{3})(\d{3})(\d{3})(\d{3})(\d{3})(\d{3})(\d{1,2})/, '$1.$2.$3.$4.$5.$6.$7,$8');
  }

  if(value.length >= 29) {
    //  1.000.000.000.000.000.000,000 -> 10.000.000.000.000.000.000,00
    return value
      .replace(/\D/g, '')
      .replace(/(\d{2})(\d{3})(\d{3})(\d{3})(\d{3})(\d{3})(\d{3})(\d{1,2})/, '$1.$2.$3.$4.$5.$6.$7,$8');
  }
